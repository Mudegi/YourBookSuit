                    ...
                    <div className="grid grid-cols-4 divide-x divide-gray-200 dark:divide-slate-700">
                      ...
                      <div className="p-4">
                        ...
                        <div className="space-y-1">
                          ...
                          <button onClick={() => { setCreateMenuOpen(false); window.location.href = `/${orgSlug}/payments/vendor`; }} className="w-full text-left block px-3 py-2 text-sm text-gray-700 hover:bg-green-50 hover:text-green-700 rounded-md transition-colors">Pay bills</button>
