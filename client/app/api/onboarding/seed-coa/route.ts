...
const getIndustryAccounts = (industry: string) => {
  ...
  const industrySpecific: Record<string, any[]> = {
    ...
    manufacturing: [
      { code: '1310', name: 'Raw Materials', type: 'ASSET', category: 'Current Assets' },
      { code: '1320', name: 'Work in Progress', type: 'ASSET', category: 'Current Assets' },
      { code: '1330', name: 'Finished Goods', type: 'ASSET', category: 'Current Assets' },
