  ...
  try {
    ...
    return NextResponse.json({
      ...
      data: {
        ...
        exciseRate: product.exciseRate ? Number(product.exciseRate) : null,
        exciseRule: product.exciseRule || '',
        exciseUnit: product.exciseUnit || '',
        pack: product.pack ? Number(product.pack) : null,
        stick: product.stick ? Number(product.stick) : null,
  ...
  try {
    ...
    const product = await prisma.product.update({
      ...
      data: {
        ...
        exciseRate: input.exciseRate ?? null,
        exciseRule: input.exciseRule ?? null,
        exciseUnit: input.exciseUnit ?? null,
        pack: input.pack ?? null,
        stick: input.stick ?? null,
